...
item1.addEventListener("click", function(){
    ...
    info2.innerHTML = "<br>This book is in fact one of my favourite of all time because of the mystery and intrigue of the story. At no <br> point when reading this book did I feel compelled to put it down due to immense boredom.<br> Dan Brown has remained one of my all-time favourite authors with his release of 'Inferno' <br>in May of 2013.";
        ...
        //section used to show what needs to be displayed when The DaVinci Code image is clicked               
...
//section used to show what needs to be displayed when How to Not Be Wrong image is clicked
...
//section used to show what needs to be displayed when Ham on Rye image is clicked
...
//section used to show what needs to be displayed when the Gone Girl image is clicked
// JavaScript File